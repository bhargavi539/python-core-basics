...
name = print_my_name_as("Edward Thompson")
print(name)
...
get_user_details("Edward",35,100000)

get_user_details(name="Edward",salary=100000,age=35)
...
var_argument("Oxford","Edward","Cory","Tom","Selvan",12,2.2,True)